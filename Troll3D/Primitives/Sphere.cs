...
namespace Troll3D{
    ...
    /// <summary>
    /// La classe Sphere contient des méthodes permettant de créer un maillage représentant une sphère
    /// </summary>
    public class Sphere 
    {
        ...
        /// <summary>
        /// Retourne un maillage dont les faces pointent vers l'intérieur de la sphère
        /// </summary>
        public static Mesh ReverseMesh( float radius, int xdiscretisation, int ydiscretisation )
        {
            StandardMesh mesh = new StandardMesh();
            ...
            for (int i = 0; i < ydiscretisation-1; i++) {
                for (int j = 0; j < xdiscretisation-1; j++) {
                    ...
                    mesh.AddFace(
                        1 + xdiscretisation * i + j,            // 1
                        1 + xdiscretisation *   i + j + 1 ,     // 5
                        1 + xdiscretisation * ( i + 1 ) + j);   // 2

...
namespace Troll3D
{
    ...
    public abstract class BaseCurve
    {
        ...
        public List<Vector3> GetContolPoints() { return m_controlpoints; }
        public int GetControlPointCount() { return m_controlpoints.Count; }

        public List<Vector3> GetCurve() { return m_points; }
        ...
        public int GetDiscretisation() { return m_discretisation; }
